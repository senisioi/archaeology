...
- [Colab](https://colab.research.google.com/drive/1NmFVJH5YyDDCJQ1abXq4TVOYznf1kngE)

This content is reproduced from: François Dominic Laramée, "Introduction to stylometry with Python," Programming Historian 7 (2018), https://doi.org/10.46430/phen0078, [access here](https://programminghistorian.org/en/lessons/introduction-to-stylometry-with-python)


It represents a coding excercise based on the seminal work from the early '60s of Frederick Mosteller and David L. Wallace, [Inference and Disputed Authorship] and [Inference in an Authorship Problem](https://ptrckprry.com/course/ssd/reading/Most63.pdf).
...
A dataset in json format is available [here](https://ptrckprry.com/course/ssd/data/federalist.json).
To work through this lesson, you will need to download and unzip the archive of the _Federalist Papers_ ([.zip]()) containing the 85 documents that we will use for our analysis. The archive also contains the [original Project Gutenberg ebook](http://www.gutenberg.org/cache/epub/1404/pg1404.txt) version of the _Federalist Papers_ from which these 85 documents have been extracted. When you unzip the archive, it will create a [directory](https://en.wikipedia.org/wiki/Directory_(computing)) called `data` in your current [working directory](https://en.wikipedia.org/wiki/Working_directory). Make sure that you stay in this current working directory and that you save all work here while completing the lesson.
